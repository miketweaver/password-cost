...
# Flags/Arguments
parser = argparse.ArgumentParser(description='Process some passwords.', allow_abbrev=True)
...
if args.gui:
	...
	app = gui("PassCalc", "400x325", handleArgs=False)
...
############## CMD Line ##############
	...
	print("# of Chars: " + str(length))
	print("# of Charset: " + str(charcount))
	print("# of Hashes: " + str(hashes))
